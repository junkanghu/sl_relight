...
def get_opt():
    ...
    parser.add_argument('--txt_dir', type=str, default='./path_txt',
                        help='Output directory')
    parser.add_argument('--test_dir', type=str, default='/nas/home/hujunkang/resized_real_data/img',
                        help='Test data directory')

    parser.add_argument('--save_fre', type=int, default=1)
